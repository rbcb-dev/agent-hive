...
describe('FileIcon', () => {
  describe('directory icons', () => {
    it('renders folder icon for directories', () => {
      const { container } = render(<FileIcon filename="src" isDirectory={true} />);
  ...
  describe('file type mapping', () => {
    it('renders file-code icon for TypeScript files', () => {
      const { container } = render(<FileIcon filename="Button.tsx" isDirectory={false} />);
    ...
    it('renders file-code icon for JavaScript files', () => {
      const { container } = render(<FileIcon filename="index.js" isDirectory={false} />);
    ...
    it('renders file-code icon for Python files', () => {
      const { container } = render(<FileIcon filename="main.py" isDirectory={false} />);
    ...
    it('renders file-text icon for JSON files', () => {
      const { container } = render(<FileIcon filename="package.json" isDirectory={false} />);
    ...
    it('renders file-text icon for YAML files', () => {
      const { container } = render(<FileIcon filename="config.yml" isDirectory={false} />);
    ...
    it('renders markdown icon for markdown files', () => {
      const { container } = render(<FileIcon filename="README.md" isDirectory={false} />);
    ...
    it('renders lock icon for lock files', () => {
      const { container } = render(<FileIcon filename="package-lock.json" isDirectory={false} />);
      
      // Lock files use the lock extension, not json
      // Actually lock is the extension here, so we need to check this
      const { container: lockContainer } = render(<FileIcon filename="bun.lock" isDirectory={false} />);
    ...
    it('renders gear icon for env files', () => {
      const { container } = render(<FileIcon filename=".env" isDirectory={false} />);
    ...
    it('renders default file icon for unknown extensions', () => {
      const { container } = render(<FileIcon filename="data.xyz" isDirectory={false} />);
    ...
    it('renders default file icon for files without extension', () => {
      const { container } = render(<FileIcon filename="Makefile" isDirectory={false} />);
