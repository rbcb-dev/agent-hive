  ...
  return [
    {
      ...
      modelDescription:
        'Write a context file to store research findings, decisions, or reference material. Context persists and helps workers understand background.',
      inputSchema: {
        type: 'object',
        properties: {
      ...
      invoke: async (input) => {
        const { feature, name, content } = input as {
          feature: string;
          name: string;
          content: string;
        };
