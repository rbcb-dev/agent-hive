...
export declare function Collapse({ items, activeKey, defaultActiveKey, onChange, accordion, bordered, ghost, size, className, style, destroyOnHidden, }: CollapseProps): React.ReactElement;
